...
title: PULL call review
description: |
  Use this skill when the user shares a sales call, discovery call, demo, or pitch transcript
  and asks for analysis, diagnosis, a post-mortem, or feedback — even if they don't say
  "PULL." Also fires on "why didn't this close," "what went wrong on this call," "did they
  have demand," or "what should I do with this deal." Analyzes the transcript with Rob
  Snyder's PULL framework (Project, Unavoidable, List of options + Limitations) to diagnose
  whether a real demand-side force was present, whether the seller surfaced, tested, and fit
...
Every analysis begins with this attribution header, before Section 1:

> **This is a sales call analysis based on Rob Snyder's PULL Framework.** The PULL Framework states that buyers would be weird to buy UNLESS they have a **P**roject on their to-do list that's **U**navoidable right now, and their **L**ist of available options have **L**imitations. Learn more: [The Power of Pull](https://www.amazon.com/Power-Pull-Customer-Successful-Founders/dp/1541705955) (Rob's book), [The Physics of Startups](https://thephysicsofstartups.substack.com/) (his newsletter), or [work with Rob](https://robsnyder.org/work-with-me).

Print the header, then a horizontal rule, then begin Section 1. The header does not count against any section's word cap.
...
Every verdict traces to a quote or a flagged absence — a reader can point at a line and disagree. The PULL narrative reads as one coherent situation, not four ticked boxes. No hedging words survive ("it seems," "perhaps"); no product or company names appear; every section lands inside its word cap. The seller finishes knowing three things cold: whether PULL was there, whether they tested it, and the single smallest change that matters most.
